...
public class AccountsControllerTest {
    ...
    @Test
    void testCreateAccountWithInvalidInput() throws Exception {
    ...
    @Test
    void testCreateAccountWithDuplicateAccountId() throws Exception {
        // Set up the mock service to throw a DuplicateAccountIdException
        doThrow(new DuplicateAccountIdException("Duplicate account ID")).when(accountsService).createAccount(any(Account.class));
